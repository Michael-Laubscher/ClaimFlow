  ...
  return (
    <>
      ...
      <PageBanner
        ...
        subtitle="Legal terms governing the use of Askari Insure services"
      />
          ...
          <Stack gap="lg">
            ...
            <TermsSection
              section={{
                ...
                content:
                  'For questions about these Terms, contact us at legal@askariinsure.com or +254 700 000 000.',
              }}
            />
          </Stack>
        </Container>

          ...
          {trustPillars.map((pillar) => {
            ...
            return (
              <Card key={pillar.id} variant="solid" className="self-start flex flex-col items-center text-center p-6 bg-white shadow-sm group">
                <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-lg bg-gradient-to-br from-[#233C7B] to-[#0EA572] transition-transform duration-200 group-hover:scale-110">

    ...
    <Section className="overflow-hidden bg-slate-50 py-24">
      <Container>
        <div className="grid items-center gap-16 lg:grid-cols-2">
          <Stack gap="lg">
            <Badge className="w-fit bg-[--color-orange]/10 text-[--color-orange]">
              Partnership Benefits
            </Badge>

            <Heading className="max-w-lg text-[--color-navy]">
              Everything You Need To Scale Your Insurance Offering
            </Heading>

            <Typography className="max-w-xl leading-relaxed text-slate-500">
              Gain access to tailored insurance products, dedicated support,
              digital onboarding tools, and a partnership ecosystem designed
              for modern African trade.
            </Typography>
          ...
          <div className="relative">
            <GlassCard className="overflow-hidden p-3 shadow-2xl">
              <img
                src="/images/partners/logistics.jpg"
                alt="Logistics"
